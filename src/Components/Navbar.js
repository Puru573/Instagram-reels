...
export default function Navbar({userData}) {
  ...
  const handleExplore=()=>{
    const win=window.open("https://www.linkedin.com/in/puru-pal-407a191a6/");
    win.focus()
  }
  ...
  const renderMenu = (
    ...
    >
      ...
      <MenuItem onClick={handlelogout}><ExitToAppIcon/><span>&nbsp;&nbsp;</span>log out</MenuItem>
    </Menu>
  );
        ...
        <Toolbar>
          ...
          <Box sx={{ display: { xs: 'none', md: 'flex' },color:'black',alignItems:"center",marginRight:'3rem' }}>
            ...
            <IconButton
              ...
              color="inherit"
            >
                 <Avatar src={userData.profileUrl} sx={{height:"2rem",width:"2rem",backgroundSize:"cover"}}/>
